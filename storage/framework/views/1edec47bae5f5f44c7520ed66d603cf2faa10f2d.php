...
<div class="row">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    <h5 class="card-title me-2">حالة السوق</h5>
                    <div class="ms-auto">
                        <div>
    ...
    <div class="col-xl-4">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="d-flex flex-wrap align-items-center mb-4">
                    <h5 class="card-title me-2">المبيعات بحسب المواقع</h5>
                    <div class="ms-auto">
                        <div class="dropdown">
...
<div class="row">
    <div class="col-xl-3">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">قائمة العملاء</h4>
                <div class="flex-shrink-0">
                    <div class="dropdown">
                        <a class=" dropdown-toggle" href="#" id="dropdownMenuButton2"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="text-muted">جميع الاعضاء<i class="mdi mdi-chevron-down ms-1"></i></span>
                        </a>

                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
                            <a class="dropdown-item" href="#">الاعضاء</a>
                            <a class="dropdown-item" href="#">الاعضاء الجدد</a>
                            <a class="dropdown-item" href="#">الاعضاء الاقدم</a>
                        </div>
                    </div>
                </div>
            </div><!-- end card header -->
                ...
                <div class="px-3" data-simplebar style="max-height: 386px;">
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="<?php echo e(URL::asset('./assets/backend/images/users/avatar-2.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="<?php echo e(URL::asset('./assets/backend/images/users/avatar-4.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="<?php echo e(URL::asset('./assets/backend/images/users/avatar-5.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="<?php echo e(URL::asset('./assets/backend/images/users/avatar-6.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="<?php echo e(URL::asset('./assets/backend/images/users/avatar-8.jpg')); ?>" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
    ...
    <div class="col-xl-5">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">المنتجات</h4>
                <div class="flex-shrink-0">
                    <div class="dropdown align-self-start">
                        <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <table class="table align-middle table-nowrap ">
                            <tbody>
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="<?php echo e(URL::asset('./assets/backend/images/product/img-1.png')); ?>" class="img-fluid" alt="">
                                        </div>
                                    </td>
    ...
    <div class="col-xl-4">
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">الدردشات</h4>
                <div class="flex-shrink-0">
                    <select class="form-select form-select-sm mb-0 my-n1">
                        <option value="Today" selected="">اليوم</option>
                        <option value="Yesterday">بالامس</option>
                        <option value="Week">منذ اسبوع</option>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduate\myproject\e-com-site\Admin\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>