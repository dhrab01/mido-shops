                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            <a href="<?php echo e(url('admin/add_edit_banner')); ?>" class="btn  btn-primary btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> اضافة  جديد</a>
                        </div>
                    </div><!-- end col-->
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" class="updateStatus" id="module-<?php echo e($banner['id']); ?>" module="banner" module_id="<?php echo e($banner['id']); ?>" status="Active" switch="primary" checked />
                                    <label for="module-<?php echo e($banner['id']); ?>" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    <?php else: ?>
                                    <input type="checkbox" class="updateStatus" id="module-<?php echo e($banner['id']); ?>" module="banner" module_id="<?php echo e($banner['id']); ?>" status="Inactive" switch="primary" />
                                    <label for="module-<?php echo e($banner['id']); ?>" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    <?php endif; ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li><a href="<?php echo e(url('admin/add_edit_banner/'.$banner['id'])); ?>" class="dropdown-item btn  btn-primary btn-rounded edit-btn" value="<?php echo e($banner['id']); ?>"><i class="edit-btn mdi mdi-pencil font-size-16 text-primary me-1"></i> تعديل</a></li>
                                            <li><a title="العرض" href="javascript:void(0)" class="conformDelete dropdown-item btn  btn-primary btn-rounded" module="banner" moduleid="<?php echo e($banner['id']); ?>"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> حذف</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduate\myproject\e-com-site\Admin\resources\views/admin/banners/banners.blade.php ENDPATH**/ ?>