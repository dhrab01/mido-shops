                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" class="updateStatus" id="module-<?php echo e($admin['id']); ?>" module="admin" module_id="<?php echo e($admin['id']); ?>" status="Active" switch="primary" checked />
                                    <label for="module-<?php echo e($admin['id']); ?>" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    <?php else: ?>
                                    <input type="checkbox" class="updateStatus" id="module-<?php echo e($admin['id']); ?>"  module="admin" module_id="<?php echo e($admin['id']); ?>" status="Inactive" switch="primary"  />
                                    <label for="module-<?php echo e($admin['id']); ?>" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    <?php endif; ?>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu ">
                                            ...
                                            <li><a href="<?php echo e(url('admin/view-vendor-details/'.$admin['id'])); ?>" class="dropdown-item"><i class="mdi mdi-account-details font-size-16 text-primary me-1"></i> عرض معلومات الحساب</a></li>
                                            
                                            <?php else: ?>
                                            <li><a href="<?php echo e(url('admin/update-admin-profile/profile')); ?>" class="dropdown-item"><i class="mdi mdi-pencil font-size-16 text-primary me-1"></i> تعديل</a></li>
