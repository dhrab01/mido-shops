                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_name'])): ?> value="<?php echo e($products['product_name']); ?>" <?php else: ?> value="<?php echo e(old('product_name')); ?>" <?php endif; ?>>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_code'])): ?> value="<?php echo e($products['product_code']); ?>" <?php else: ?> value="<?php echo e(old('product_code')); ?>" <?php endif; ?>>
                            </div>
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_color'])): ?> value="<?php echo e($products['product_color']); ?>" <?php else: ?> value="<?php echo e(old('product_color')); ?>" <?php endif; ?>>
                            </div>
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_price'])): ?> value="<?php echo e($products['product_price']); ?>" <?php else: ?> value="<?php echo e(old('product_price')); ?>" <?php endif; ?>>
                            </div>
                             <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_unit'])): ?> value="<?php echo e($products['product_unit']); ?>" <?php else: ?> value="<?php echo e(old('product_unit')); ?>" <?php endif; ?>>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_discount'])): ?> value="<?php echo e($products['product_discount']); ?>" <?php else: ?> value="<?php echo e(old('product_discount')); ?>" <?php endif; ?>>
                            </div>
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['product_weight'])): ?> value="<?php echo e($products['product_weight']); ?>" <?php else: ?> value="<?php echo e(old('product_weight')); ?>" <?php endif; ?>>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['meta_title'])): ?> value="<?php echo e($products['meta_title']); ?>" <?php else: ?> value="<?php echo e(old('meta_title')); ?>" <?php endif; ?>>
                            </div>
                            <div class="mb-3">
                                ...
                                <?php if(!empty($products['meta_keywords'])): ?> value="<?php echo e($products['meta_keywords']); ?>" <?php else: ?> value="<?php echo e(old('meta_keywords')); ?>" <?php endif; ?>>
                            </div>
                        </div>
