    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li class="menu-title" data-key="t-apps">ادارة المستخدمين </li>

                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="shopping-cart"></i>
                        <!-- <span data-key="t-ecommerce"><?php echo app('translator')->get('translation.Ecommerce'); ?></span> -->
                        <span data-key="t-ecommerce">المدراء</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products"><?php echo app('translator')->get('translation.Products'); ?></a></li> -->
                        <li><a href="<?php echo e(url('admin/admins')); ?>"> جميع المدراء</a></li>
                        <li><a href="<?php echo e(url('admin/admins/admin')); ?>"> مدراء النظام</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail"><?php echo app('translator')->get('translation.Product_Detail'); ?></a></li> -->
                        <li><a href="<?php echo e(url('admin/admins/subadmin')); ?>"> مشرفي الاقسام</a></li>
                        <!-- <li><a href="ecommerce-orders" data-key="t-orders"><?php echo app('translator')->get('translation.Orders'); ?></a></li> -->
                        <li><a href="<?php echo e(url('admin/admins/vendor')); ?>"> البائعين</a></li>
                        <!-- <li><a href="ecommerce-customers" data-key="t-customers"><?php echo app('translator')->get('translation.Customers'); ?></a></li> -->
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="shopping-cart"></i>
                        <!-- <span data-key="t-ecommerce"><?php echo app('translator')->get('translation.Ecommerce'); ?></span> -->
                        <span data-key="t-ecommerce">المستخدمين</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products"><?php echo app('translator')->get('translation.Products'); ?></a></li> -->
                        <li><a href="<?php echo e(url('admin/customers')); ?>"> العملاء</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail"><?php echo app('translator')->get('translation.Product_Detail'); ?></a></li> -->
                        <li><a href="<?php echo e(url('admin/subscripers')); ?>"> المشتركين</a></li>
                 ...
                 <li class="menu-title" data-key="t-banners">ادارة العروض</li>
                  ...
                  <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products"><?php echo app('translator')->get('translation.Products'); ?></a></li> -->
                        <li><a href="<?php echo e(url('admin/banners')); ?>">كل العروض</a></li>
                        <li><a href="<?php echo e(url('admin/add_edit_banner')); ?>">اضافة عرض جديد</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail"><?php echo app('translator')->get('translation.Product_Detail'); ?></a></li> -->
                    </ul>
                </li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="shopping-cart"></i>
                        <!-- <span data-key="t-ecommerce"><?php echo app('translator')->get('translation.Ecommerce'); ?></span> -->
                        <span data-key="t-ecommerce">الطلبات</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products"><?php echo app('translator')->get('translation.Products'); ?></a></li> -->
                        <li><a href="#" key="t-products">جميع الطلبات</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail"><?php echo app('translator')->get('translation.Product_Detail'); ?></a></li> -->
                        <li><a href="#" data-key="t-product-detail">مرتبط</a></li>
                        <!-- <li><a href="ecommerce-orders" data-key="t-orders"><?php echo app('translator')->get('translation.Orders'); ?></a></li> -->
                        <li><a href="ecommerce-orders" data-key="t-orders">تم التاكيد</a></li>
                        <!-- <li><a href="ecommerce-customers" data-key="t-customers"><?php echo app('translator')->get('translation.Customers'); ?></a></li> -->
                        <li><a href="ecommerce-customers" data-key="t-customers">قيد التجهيز</a></li>
                        <!-- <li><a href="ecommerce-cart" data-key="t-cart"><?php echo app('translator')->get('translation.Cart'); ?></a></li> -->
                        <li><a href="ecommerce-cart" data-key="t-cart">قيد التوصيل</a></li>
                        <!-- <li><a href="ecommerce-checkout" data-key="t-checkout"><?php echo app('translator')->get('translation.Checkout'); ?></a></li> -->
                        <li><a href="ecommerce-checkout" data-key="t-checkout">تم التوصيل</a></li>
                        <!-- <li><a href="ecommerce-shops" data-key="t-shops"><?php echo app('translator')->get('translation.Shops'); ?></a></li> -->
                        <li><a href="ecommerce-shops" data-key="t-shops">طلبات مرجوعة</a></li>
                        <!-- <li><a href="ecommerce-add-product" data-key="t-add-product"><?php echo app('translator')->get('translation.Add_Product'); ?></a></li> -->
                        <li><a href="ecommerce-add-product" data-key="t-add-product">فشل التوصيل</a></li>
                        <li><a href="ecommerce-add-product" data-key="t-cencel">ملغي</a></li>
                ...
                <li>
                    <a href="javascript: void(0);" class="has-arrow">
                        <i data-feather="shopping-cart"></i>
                        <!-- <span data-key="t-ecommerce"><?php echo app('translator')->get('translation.Ecommerce'); ?></span> -->
                        <span data-key="t-refund-request">طلبات الارجاع</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products"><?php echo app('translator')->get('translation.Products'); ?></a></li> -->
                        <li><a href="#" key="t-pinding">مرتبط</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail"><?php echo app('translator')->get('translation.Product_Detail'); ?></a></li> -->
                        <li><a href="#" data-key="t-approved">موافق عليها</a></li>
                        <!-- <li><a href="ecommerce-orders" data-key="t-orders"><?php echo app('translator')->get('translation.Orders'); ?></a></li> -->
                        <li><a href="ecommerce-orders" data-key="t-refunded">مردودة</a></li>
                        <!-- <li><a href="ecommerce-customers" data-key="t-customers"><?php echo app('translator')->get('translation.Customers'); ?></a></li> -->
                        <li><a href="ecommerce-customers" data-key="t-rejected">مرفوضة</a></li>
