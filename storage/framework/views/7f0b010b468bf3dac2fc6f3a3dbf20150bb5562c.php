                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="banner_type" id="banner_type" class="form-control select2">
                                    ...
                                    <option value="slider" <?php if(!empty($banner['type']) && $banner['type']=="slider"): ?> selected <?php endif; ?>>Slider</option>
                                    <option value="fix" <?php if(!empty($banner['type']) && $banner['type']=="fix"): ?> selected <?php endif; ?>>Fix</option>
                                    <option value="footer" <?php if(!empty($banner['type']) && $banner['type']=="footer"): ?> selected <?php endif; ?>>Footer</option>
                        ...
                        <div class="col-sm-6">
                            <div class="mb-3">
                                ...
                                <select name="banner_class" id="banner_class" class="form-control select2">
                                    ...
                                    <option value="<?php echo e($cl['name']); ?>" <?php if(!empty($banner['class']) && $banner['class']==$cl['name']): ?> selected <?php endif; ?>><?php echo e($cl['name']); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\graduate\myproject\e-com-site\Admin\resources\views/admin/banners/add_edit_banner.blade.php ENDPATH**/ ?>