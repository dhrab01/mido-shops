...
<div class="auth-page">
    <div class="container-fluid p-0">
        <div class="row g-0">
                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="index" class="d-block auth-logo">
                                    <img src="<?php echo e(URL::asset('assets/backend/images/logo-sm.svg')); ?>" alt="" height="28"> <span class="logo-txt">Mido Shop</span>
                                </a>
                            </div>
            ...
            <?php if(!empty($admin_banner)): ?>
                 <div style="background-image:url('<?php echo e(asset('/images/photos/'.$admin_banner)); ?>');" class="auth-bg pt-md-5 p-4 d-flex">
            <?php else: ?>
