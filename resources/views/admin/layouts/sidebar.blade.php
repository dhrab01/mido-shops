            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ url('admin/update-vendor-details/personal') }}"> البيانات الشخصية</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail">@lang('translation.Product_Detail')</a></li> -->
                        <li><a href="{{ url('admin/update-vendor-details/business') }}">بيانات المتجر</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products">@lang('translation.Products')</a></li> -->
                        <li><a href="{{ url('admin/admins') }}"> جميع المدراء</a></li>
                        <li><a href="{{ url('admin/admins/admin') }}"> مدراء النظام</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail">@lang('translation.Product_Detail')</a></li> -->
                        <li><a href="{{ url('admin/admins/subadmin') }}"> مشرفي الاقسام</a></li>
                        <!-- <li><a href="ecommerce-orders" data-key="t-orders">@lang('translation.Orders')</a></li> -->
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <!-- <li><a href="ecommerce-products" key="t-products">@lang('translation.Products')</a></li> -->
                        <li><a href="{{ url('admin/customers') }}"> العملاء</a></li>
                        <!-- <li><a href="ecommerce-product-detail" data-key="t-product-detail">@lang('translation.Product_Detail')</a></li> -->
                        <li><a href="{{ url('admin/subscripers') }}"> المشتركين</a></li>
