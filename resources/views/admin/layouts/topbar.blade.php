        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-none d-sm-inline-block">
                ...
                @switch(Session::get('lang'))
                    ...
                    @break
                    @case('ar')
                        <img src="{{ URL::asset('/assets/backend/images/flags/ye.jpg')}}" alt="Header Language" height="16">
                    @break
                    @case('es')
            ...
            <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="{{ url('dashboard/en') }}" class="dropdown-item notify-item language" data-lang="eng">
                    <img src="{{ URL::asset ('/assets/backend/images/flags/ye.jpg') }}" alt="user-image" class="me-1" height="12"> <span class="align-middle">English</span>
                </a>
                 <!-- item-->
                ...
                <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0"
                    ...
                    <div data-simplebar style="max-height: 230px;">
                        ...
                        <a href="#!" class="text-reset notification-item">
                            <div class="d-flex">
                                <div class="flex-shrink-0 me-3">
                                    <img src="assets/backend/images/users/avatar-6.jpg" class="rounded-circle avatar-sm" alt="user-pic">
                                </div>
                                <div class="flex-grow-1">
            ...
            <div class="dropdown d-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    @else
                    <a class="dropdown-item" href="{{ url('admin/update-admin-profile')  }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> الاعدادات</a>
                    <a class="dropdown-item" href="auth-lock-screen"><i class="mdi mdi-lock font-size-16 align-middle me-1"></i> اغلاق الشاشة</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item " href="javascript:void();" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-power-off font-size-16 align-middle me-1"></i> <span key="t-logout">تسجيل الخروج</span></a>
                    <form id="logout-form" action="{{ url('admin/logout')  }}" method="POST" style="display: none;">
