                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            <a href="{{ url('admin/add_edit_category') }}" class="btn  btn-primary btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> اضافة صنف جديد</a>
                        </div>
                    </div><!-- end col-->
                </div>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        <div class="flex-shrink-0">
                                        <div class="avatar-md me-3">
                                                <img src="{{ URL::asset('images/front/categories/avatar-3.jpg') }}" alt="category-image" class="img-fluid  d-block img-thumbnail">
                                        </div>
                                    </div>
                                    @endif
                                </td>
                                ...
                                <td>
                                    ...
                                    <input type="checkbox" class="updateStatus" id="module-{{$category['id']}}" module="category" module_id="{{$category['id']}}" status="Active" switch="primary" checked />
                                    <label for="module-{{$category['id']}}" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    @else
                                    <input type="checkbox" class="updateStatus" id="module-{{$category['id']}}" module="category" module_id="{{$category['id']}}" status="Inactive" switch="primary" />
                                    <label for="module-{{$category['id']}}" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    @endif
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li><a href="{{ url('admin/add_edit_category/'.$category['id']) }}" class="dropdown-item btn  btn-primary btn-rounded edit-btn" value="{{$category['id']}}"><i class="edit-btn mdi mdi-pencil font-size-16 text-primary me-1"></i> تعديل</a></li>
                                            <li><a title="الصنف" href="javascript:void(0)" class="conformDelete dropdown-item btn  btn-primary btn-rounded" module="category" moduleid="{{$category['id']}}"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> حذف</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
