                ...
                <div class="px-3" data-simplebar style="max-height: 386px;">
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="{{ URL::asset('./assets/backend/images/users/avatar-2.jpg') }}" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="{{ URL::asset('./assets/backend/images/users/avatar-4.jpg') }}" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="{{ URL::asset('./assets/backend/images/users/avatar-5.jpg') }}" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="{{ URL::asset('./assets/backend/images/users/avatar-6.jpg') }}" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center pb-4">
                        <div class="avatar-md me-4">
                            <img src="{{ URL::asset('./assets/backend/images/users/avatar-8.jpg') }}" class="img-fluid rounded-circle" alt="">
                        </div>
                        <div class="flex-grow-1">
                        ...
                        <table class="table align-middle table-nowrap ">
                            <tbody>
                                <tr>
                                    <td style="width: 50px;">
                                        <div class="avatar-md me-4">
                                            <img src="{{ URL::asset('./assets/backend/images/product/img-1.png') }}" class="img-fluid" alt="">
                                        </div>
                                    </td>
