            ...
            <div class="col-sm-auto">
                <div class="d-flex align-items-start justify-content-end gap-2 mb-2">
                    <div>
                        ...
                        <a class="btn btn-secondary" href="{{ url('admin/update-admin-password') }}" ><i class="me-1"></i> تغيير كلمة المرور</a>
    ...
    <div class="col-12  stretch-card">
        <div class="card">
            <div class="card-body">
              ...
              @endif
                <form class="forms-sample"  method="post" action="{{ url('admin/update-admin-profile') }}" enctype="multipart/form-data">@csrf
