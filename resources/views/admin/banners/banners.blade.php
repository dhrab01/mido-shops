                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <div class="text-sm-end">
                            <a href="{{ url('admin/add_edit_banner') }}" class="btn  btn-primary btn-rounded waves-effect waves-light mb-2 me-2"><i class="mdi mdi-plus me-1"></i> اضافة  جديد</a>
                        </div>
                    </div><!-- end col-->
                </div>
            </div>
                    ...
                    <table id="banner" class="data-table table align-middle table-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($banner['status']==1)
                                    <input type="checkbox" class="updateStatus" id="module-{{$banner['id']}}" module="banner" module_id="{{$banner['id']}}" status="Active" switch="primary" checked />
                                    <label for="module-{{$banner['id']}}" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    @else
                                    <input type="checkbox" class="updateStatus" id="module-{{$banner['id']}}" module="banner" module_id="{{$banner['id']}}" status="Inactive" switch="primary" />
                                    <label for="module-{{$banner['id']}}" data-on-label="مفعل" data-off-label="غير مفعل"></label>
                                    @endif
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu ">
                                            <li><a href="{{ url('admin/add_edit_banner/'.$banner['id']) }}" class="dropdown-item btn  btn-primary btn-rounded edit-btn" value="{{$banner['id']}}"><i class="edit-btn mdi mdi-pencil font-size-16 text-primary me-1"></i> تعديل</a></li>
                                            <li><a title="العرض" href="javascript:void(0)" class="conformDelete dropdown-item btn  btn-primary btn-rounded" module="banner" moduleid="{{$banner['id']}}"><i class="mdi mdi-trash-can font-size-16 text-danger me-1"></i> حذف</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
