                                        ...
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ URL::asset('assets/frontend/images/640.png')}}" alt="el_img.$i')}}">
                                                    <img class="product_hover_img" src="{{ URL::asset('assets/frontend/images/640.png')}}" alt="el_img.$i')}}">
                                                </a>
                                ...
                                <div class="product_slider carousel_slider owl-carousel owl-theme dot_style1" data-loop="true" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "991":{"items": "4"}}'>
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ URL::asset('assets/frontend/images/el_img7.jpg')}}" alt="el_img7">
                                                    <img class="product_hover_img" src="{{ URL::asset('assets/frontend/images/el_hover_img7.jpg')}}" alt="el_hover_img7">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            ...
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ URL::asset('assets/frontend/images/el_img8.jpg')}}" alt="el_img8">
                                                    <img class="product_hover_img" src="{{ URL::asset('assets/frontend/images/el_hover_img8.jpg')}}" alt="el_hover_img8">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
                                    ...
                                    <div class="item">
                                        <div class="product_wrap">
                                            <div class="product_img">
                                                <a href="shop-product-detail.html">
                                                    <img src="{{ URL::asset('assets/frontend/images/el_img9.jpg')}}" alt="el_img9">
                                                    <img class="product_hover_img" src="{{ URL::asset('assets/frontend/images/el_hover_img9.jpg')}}" alt="el_hover_img9">
                                                </a>
                                                <div class="product_action_box">
                                                    <ul class="list_none pr_action_btn">
                                                        <li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
            	...
            	<div class="product_slider carousel_slider owl-carousel owl-theme nav_style3" data-loop="true" data-dots="false" data-nav="true" data-margin="30" data-responsive='{"0":{"items": "1"}, "650":{"items": "2"}, "1199":{"items": "2"}}'>
            		<div class="item">
                        <div class="deal_wrap">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{ URL::asset('assets/frontend/images/el_img1.jpg')}}" alt="el_img1">
                                </a>
                            </div>
                    ...
                    <div class="item">
                        <div class="deal_wrap">
                            <div class="product_img">
                                <a href="shop-product-detail.html">
                                    <img src="{{ URL::asset('assets/frontend/images/el_img2.jpg')}}" alt="el_img2">
                                </a>
                            </div>
                            <div class="deal_content">
                                <div class="product_info">
